...
const Membership: FunctionalComponent = () => {
    return (
        <div class={style.membership}>
            <Helmet>
                <title>Greater Toronto Multiple Alarm Association - Membership</title>
            </Helmet>
            <h1>MEMBERSHIP</h1>
            ...
            <div class={cx(style.section, style.group)}>
                ...
                <img class={cx(style.col, style.span_1_of_3)} src="/assets/people/members-and-canteen-at-station-221-opening_thumb.jpg" />
            </div>

            <section>
                <div class={cx(style.section, style.group)}>
                    <img class={cx(style.col, style.span_1_of_3)} src="/assets/people/carolyn-and-jen-at-mississauga-call_thumb.jpg" />
                    <div class={cx(style.col, style.span_2_of_3)}>
